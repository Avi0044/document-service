...
public class TemplateController {
                            ...
                            examples = {
                                    @ExampleObject(name = "Template created",
                                            value = "{\n" +
                                                    ...
                                                    "    },\n" +
                                                    "    \"status\": \"ACTIVE\",\n" +
                                                    "    \"id\": \"6284e6d11f41a5763409d809\",\n" +
                                                    "    \"tag\": \"INVOICE\",\n" +
                                                    "    \"createdDate\": \"2022-05-18 18:00:09\",\n" +
                                                    "    \"lastModifiedDate\": \"2022-05-18 18:00:09\"\n" +
                                                    "}")
                            })}),
                            ...
                            examples = {
                                    @ExampleObject(name = "Get Template List",
                                            value = "{\n" +
                                                    ...
                                                    "      },\n" +
                                                    "      \"status\": \"ACTIVE\",\n" +
                                                    "      \"id\": \"628b42b31c9bc37e1cd3338b\",\n" +
                                                    "      \"tag\": \"INVOICE\",\n" +
                                                    "      \"createdDate\": \"2022-05-23 13:45:47\",\n" +
                                                    "      \"lastModifiedDate\": \"2022-05-23 13:45:47\"\n" +
                                                    "    }\n" +
                                                    "  ]\n" +
                                                    "}")
                            })}),
    ...
    public ResponseEntity<TemplateResponse> getTemplates(@RequestParam(required = true) String appId,
        ...
        TemplateResponse templateResponse = defaultTemplateService.getTemplates(appId, status);
        return ResponseEntity.status(HttpStatus.OK)
                .body(templateResponse);
    }
