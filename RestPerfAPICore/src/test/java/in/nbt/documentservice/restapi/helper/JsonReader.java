...
public class JsonReader {
    ...
    public String getJsonString(String jsonFileName) {
        ...
        try {
            ...
            TestUtils.log().error("Not able to get Json string from json file [{}]" + jsonFileName);
        }
        return jsonString;
    }
    ...
    public Map<String, Object> convertJsonStringToMap(String jsonValue) {
        ...
        try {
            ...
            TestUtils.log().error("Not able to convert Json string to map [{}]" + jsonValue);
        }
    ...
    public JSONObject convertJsonArrayToJsonObject(JSONArray jsonValue, int index) {
        ...
        try {
            ...
            TestUtils.log().error("Not able to convert Json string to jsonObject [{}]" + jsonValue);
        }
        return object;
    }
}